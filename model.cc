...
mets::gol_type my_sol::what_if(int i, bool val) const
{
    ...
    if (delta_m[i] && !val) {
        ...
        //newcover = evaluate_value(testsol);
        ...
        /*
         if (newcost < NUM) {
         return (target_sum_m - newcost)*10;
         cout <<"not fully covered, test coverage = "<<testsol.total_fore_coverage()<<endl;
         }
         else
         return target_sum_m - newcost;
         */
    }
